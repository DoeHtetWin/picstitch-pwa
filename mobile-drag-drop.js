...
!(function (t, i) {
  ...
  function c(t, i, s) {
    (void 0 === s && (s = !0),
      document.addEventListener(t, i, !!u && { passive: s }));
  }
  function f(t, i) {
  ...
  function m(t, i, s, n, h) {
    ...
    (n && ((e += n.x), (r += n.y)),
      h &&
        ((e -= parseInt(t.offsetWidth, 10) / 2),
        (r -= parseInt(t.offsetHeight, 10) / 2)));
    for (
      var o = "translate3d(" + e + "px," + r + "px, 0)", u = 0;
      u < g.length;
      u++
    ) {
      var a = g[u] + "transform";
    ...
    return (
      ...
      (t.prototype.setData = function (t, i) {
        if (2 === this.t.mode) {
          ...
          ((this.t.data[t] = i),
            -1 === this.t.types.indexOf(t) && this.t.types.push(t));
        }
      }),
  ...
  function w(t, i, s, n, h, e, r) {
    ...
    var o = (function (t, i, s, n, h, e, r) {
        ...
        var o = i.changedTouches[0],
          u = new Event(s, { bubbles: !0, cancelable: n });
        ((u.dataTransfer = e),
          (u.relatedTarget = r),
          (u.screenX = o.screenX),
          (u.screenY = o.screenY),
        ...
        return (
          (u.offsetX = u.clientX - a.left),
          (u.offsetY = u.clientY - a.top),
          u
        );
  ...
  function x(t, i) {
    ...
    } else if (i === o[2] && (0 === t.indexOf(o[2]) || t.indexOf("Move") > -1))
      return o[2];
    return o[0];
  }
  var I,
    j = (function () {
      function t(t, i, s, n) {
        ((this.h = t),
          ...
          (this.g = null),
          (this.m = t),
          (this.I = t.changedTouches[0]),
          (this.j = this.C.bind(this)),
          (this.S = this.k.bind(this)),
          c("touchmove", this.j, !1),
          c("touchend", this.S, !1),
          c("touchcancel", this.S, !1));
      }
      return (
        (t.prototype.A = function () {
          ...
          ((this.v = 1),
            (this.O = o[0]),
            (this.D = { data: {}, effectAllowed: void 0, mode: 3, types: [] }),
            (this.M = { x: null, y: null }),
            (this.F = { x: null, y: null }));
          var i = this.u;
          if (
            ((this.N = new b(this.D, function (s, n, h) {
              ((i = s),
                ("number" != typeof n && "number" != typeof h) ||
                  (t.P = { x: n || 0, y: h || 0 }));
            })),
            (this.D.mode = 2),
            (this.N.dropEffect = o[0]),
            w("dragstart", this.u, this.m, this.D, this.N))
          )
            return ((this.v = 3), this.T(), !1);
          ...
          if (
            ((this.L =
              ...
              g.map(function (t) {
                ...
                return i && "none" !== i
                  ? i.replace(/translate\(\D*\d+[^,]*,\D*\d+[^,]*\)\s*/g, "")
                  : "";
              }))),
            ...
            n.classList.add("dnd-poly-drag-image"),
            n.classList.add("dnd-poly-icon"),
            (this._ = n),
            !this.P)
          )
            if (this.o.dragImageOffset)
              ...
              this.P = {
                x:
                  e.left -
                  this.I.clientX -
                  parseInt(h.marginLeft, 10) +
                  e.width / 2,
                y:
                  e.top -
                  this.I.clientY -
                  parseInt(h.marginTop, 10) +
                  e.height / 2,
              };
            }
          return (
        ...
        (t.prototype.T = function () {
          (this.V && (clearInterval(this.V), (this.V = null)),
            f("touchmove", this.j),
            f("touchend", this.S),
            f("touchcancel", this.S),
            this._ && (this._.parentNode.removeChild(this._), (this._ = null)),
          ...
          if (!1 !== v(t, this.I.identifier)) {
            if (((this.m = t), 0 === this.v)) {
              ...
              return s
                ? void (
                    !0 === this.A() &&
                    (this.h.preventDefault(), t.preventDefault())
                  )
                : void this.T();
            }
            if (
              ...
              p("client", t, this.M),
              p("page", t, this.F),
              this.o.dragImageTranslateOverride)
            )
              try {
                var n = !1;
                if (
                  (this.o.dragImageTranslateOverride(
                    ...
                    function (t, s) {
                      i._ &&
                        ...
                        (i.F.x += t),
                        (i.F.y += s),
                        m(i._, i.F, i.L, i.P, i.o.dragImageCenterOnTouch));
                    },
                  ),
                  n)
                )
        ...
        (t.prototype.Y = function () {
          ...
          if ((h && (this.O = o[0]), h || 2 === this.v || 3 === this.v))
            return this.q(this.v)
              ? void (function (t, i, n, h) {
                  ...
                  if ("hidden" !== e.visibility && "none" !== e.display) {
                    ...
                    if (isNaN(o) || 0 === o) h();
                      ...
                      ((a.x +=
                        ...
                        (a.x -= parseInt(e.marginLeft, 10)),
                        (a.y -= parseInt(e.marginTop, 10)));
          ...
          (e !== this.p &&
            ...
            null !== this.g &&
              ((this.D.mode = 3),
              (this.N.dropEffect = o[0]),
              w("dragexit", this.g, this.m, this.D, this.N, !1)),
            null === this.p
              ? (this.g = this.p)
              : ((this.D.mode = 3),
                (this.N.dropEffect = y(this.D.effectAllowed, this.u)),
                w("dragenter", this.p, this.m, this.D, this.N)
                  ? ((this.g = this.p),
                    (this.O = x(this.N.effectAllowed, this.N.dropEffect)))
                  : this.p !== document.body && (this.g = document.body))),
            r !== this.g &&
              a(r) &&
              ((this.D.mode = 3),
              (this.N.dropEffect = o[0]),
              w("dragleave", r, this.m, this.D, this.N, !1, this.g)),
            a(this.g) &&
              ((this.D.mode = 3),
              (this.N.dropEffect = y(this.D.effectAllowed, this.u)),
              !1 === w("dragover", this.g, this.m, this.D, this.N)
                ? (this.O = o[0])
                : (this.O = x(this.N.effectAllowed, this.N.dropEffect))),
            n !== this.O && this._.classList.remove(i + n));
          var u = i + this.O;
          ...
          return (
            i
              ? a(this.g) &&
                ((this.D.mode = 3),
                (this.N.dropEffect = o[0]),
                w("dragleave", this.g, this.m, this.D, this.N, !1))
              : a(this.g) &&
                ((this.D.mode = 1),
                (this.N.dropEffect = this.O),
                !0 === w("drop", this.g, this.m, this.D, this.N)
        ...
        (t.prototype.B = function () {
          ((this.D.mode = 3),
            (this.N.dropEffect = this.O),
            w("dragend", this.u, this.m, this.D, this.N, !1),
            (this.v = 2),
            this.T());
        }),
        t
      ...
      tryFindDraggableTarget: function (t) {
        ...
        do {
          if (!1 !== i.draggable) {
            ...
            if (i.getAttribute && "true" === i.getAttribute("draggable"))
              return i;
          }
          ...
          (function t(i, s) {
            ...
            if (i.hasChildNodes())
              for (h = 0; h < i.childNodes.length; h++)
                t(i.childNodes[h], s.childNodes[h]);
          })(t, i),
          i
        );
      },
    ...
    var i = t.target,
      s = function (t) {
        (r.off(),
          ...
          i &&
            i.dispatchEvent(
              new CustomEvent(e, { bubbles: !0, cancelable: !0 }),
            ),
          clearTimeout(n));
      };
    i && i.dispatchEvent(new CustomEvent(h, { bubbles: !0, cancelable: !0 }));
  ...
  ((t.polyfill = function (t) {
    if (
      ...
      var i =
        ...
        (n = !!window.chrome || /chrome/i.test(navigator.userAgent)),
        (s.userAgentSupportingNativeDnD = !(
          /iPad|iPhone|iPod|Android/.test(navigator.userAgent) ||
          (n && "ontouchstart" in document.documentElement)
        )),
        s);
      if (i.userAgentSupportingNativeDnD && i.draggable && i.dragEvents)
        return !1;
    }
    var s, n;
